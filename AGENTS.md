...
M0-M19 are complete and version 0.1.0 is published. M20 adds one authoritative persisted weapon slot and explicit weapon profiles while preserving every previous acceptance and compatibility flow. Stop before M21.
